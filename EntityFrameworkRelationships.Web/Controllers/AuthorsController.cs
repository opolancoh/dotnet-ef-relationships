...
public class AuthorsController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult<AuthorDto>> Create(AuthorForCreatingUpdatingDto item)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(Guid id, AuthorForCreatingUpdatingDto item)
    {
        try
        {
